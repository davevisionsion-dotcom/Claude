...
- **Brand kit** — brand name, three brand colors, plain vs. gradient treatment, background preference, heading + body fonts (Google Fonts supported), bold/italic/underline emphasis preferences, logo upload, brand description/notes
